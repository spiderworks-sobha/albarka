...
Route::group(['prefix' => $prefix, 'middleware' => ['web']], function () use($middleware) {
	...
	Route::group(['middleware' => $middleware], function(){
        ...
        Route::get('/locations/create/{parent?}', [LocationController::class, 'create'])->name('admin.locations.create');
        ...
        Route::get('/locations/{parent?}', [LocationController::class, 'index'])->name('admin.locations.index');
