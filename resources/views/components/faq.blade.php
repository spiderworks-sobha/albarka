						...
						<div class="col-lg-7 col-md-7 col-sm-6 col-12">
							<div id="accordion" class="accordion">
								<div class="accordion-block">
									...
									<div class="accordion-block-item">
										<div class="accordion-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFive"><a class="accordion-title">What features do you offer and other not</a>
										</div>
