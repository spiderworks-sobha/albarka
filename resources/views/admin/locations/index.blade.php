                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="row">
                                    <div class="col">
                                        <h4 class="page-title">@if($parent_data) Sub-Location of {{$parent_data->name}} @else All Locations @endif</h4>
                                        <ol class="breadcrumb">
                                ...
                                <div class="card-body">
                                    <table class="table table-hover demo-table-search table-responsive-block" id="datatable"
                                        ...
                                        <tr>
                                            ...
                                            <th class="nosort nosearch table-width-10">Sub Locatios</th>
...
@section('footer')
    <script>
        var my_columns = [
            ...
            {data: 'sub-locations', name: 'sub-locations'},
            {data: 'priority', name: 'priority', className: 'text-center'},
            {data: 'status', name: 'status'},
            {data: 'action_edit', name: 'action_edit'},
            {data: 'action_delete_location', name: 'action_delete_location'}
        ];
        var slno_i = 0;
        var order = [0, 'desc'];
        ...
        $(function(){
            $(document).on('click', '.delete_have_child', function(){
                $.alert('Sorry! You cannot delete this location, to delete it please delete all its sub locations.');
            })
        })
    </script>
    @parent
