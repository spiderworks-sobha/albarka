<div class="col-md-3 media-previe-wrap" >
				<div class="thumbnail text-center" id="single-file-item-{{$file->id}}">
					@if($file->media_type == "Image")
						<img src="{{ asset('public/'.$file->file_path) }}" @if($file->file_type == 'image/svg+xml') width="150px;" @endif style="max-width:150px;" class="checkable @if(isset($is_new) && $is_new == 1) new_file @endif" id="{{encrypt($file->id)}}" data-original-src="{{ asset('public/'.$file->file_path) }}" data-file-path="{{$file->file_path}}">
