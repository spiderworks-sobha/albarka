                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane @if(count($files)>0) active show @endif" id="tab2Media">
                          ...
                          <div class="text-right">
                            ...
                            @elseif($popup_type == 'photogallery')
                              <button class="btn btn-primary" id="set-gallery-btn" data-url="{{route('admin.photo-galleries.update')}}"><i class="fas fa-plus-sign"></i> Set {{$title}}</button>
                            @else
